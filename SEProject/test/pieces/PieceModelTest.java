...
class PieceModelTest {
    ...
    private PieceModel wolf = new FoxModel(chessboardModel);
    private PieceModel sheep = new HoundModel(chessboardModel, true);
    private PieceModel sheepMovingDown = new HoundModel(chessboardModel, false);
